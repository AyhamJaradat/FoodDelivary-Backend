        ...
        <section class="sidebar">
            ...
            <?php echo Menu::widget([
                ...
                'items' => [
                    ...
                    [
                        'label' => Yii::t('backend', 'Meals'),
                        'icon' => '<i class="fa fa-users"></i>',
                        'url' => ['/meal/index'],
                        'active' => Yii::$app->controller->id === 'meal',
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
                    ...
                    [
                        'label' => Yii::t('backend', 'OrderMeals'),
                        'icon' => '<i class="fa fa-users"></i>',
                        'url' => ['/order-meal/index'],
                        'active' => Yii::$app->controller->id === 'order-meal',
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
                        'label' => Yii::t('backend', 'OrderLogs'),
                        'icon' => '<i class="fa fa-users"></i>',
                        'url' => ['/order-log/index'],
                        'active' => Yii::$app->controller->id === 'order-log',
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
                        'label' => Yii::t('backend', 'Users Block'),
                        'icon' => '<i class="fa fa-users"></i>',
                        'url' => ['/user-block/index'],
                        'active' => Yii::$app->controller->id === 'user-block',
                        'visible' => Yii::$app->user->can('administrator'),
                    ],
                    [
