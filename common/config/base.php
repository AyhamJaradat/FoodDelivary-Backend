...
//            'class' => yii\swiftmailer\Mailer::class,
            'class' => zyx\phpmailer\Mailer::class,
            'messageConfig' => [
                'charset' => 'UTF-8',
                'from' => env('USED_SERVER')=='live' ? env('BIOPEO_FROM_EMAIL'):env('DEV_FROM_EMAIL'),
            ],
            'htmlLayout' => '@backend/mail/layouts/html',
            'textLayout' => '',
            'useFileTransport' => false,
            'config'           => [
                'mailer'     => 'smtp',
                'host'       => env('USED_SERVER')=='live' ? env('BIOPEO_SMTP_HOST'):env('DEV_SMTP_HOST'),//live
                'port'       => env('USED_SERVER')=='live' ? env('BIOPEO_SMTP_PORT'):env('DEV_SMTP_PORT'),
                'smtpsecure' => 'tls',//STARTTLS
                'smtpauth'   => true,
                'username'   =>env('USED_SERVER')=='live' ? env('BIOPEO_SMTP_USERNAME'):env('DEV_SMTP_USERNAME'),
                'password'   => env('USED_SERVER')=='live' ? env('BIOPEO_SMTP_PASSWORD'):env('DEV_SMTP_PASSWORD'),
                'smtpoptions' => ['ssl' => [
                    'verify_peer' => false,
